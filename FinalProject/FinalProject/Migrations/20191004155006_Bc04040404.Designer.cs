...
namespace FinalProject.Migrations
{
    ...
    [Migration("20191004155006_Bc04040404")]
    partial class Bc04040404
    {
            ...
            modelBuilder.Entity("FinalProject.Models.Announcement", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 1, Info = " 64gb  Yaxshi veziyyetdedir", IsConfirmed = true, IsVip = false, ModelId = 3, Name = "Satilir Xiaomi Mi A2", PhotoUrl = "adsMain.jpg", Price = 1200m },
                        new { Id = 2, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 8, Info = "Satilir samsung galaxy s10 128 gb yasil reng.", IsConfirmed = false, IsVip = false, ModelId = 10, Name = "Satilir Samsung Galaxy S10", PhotoUrl = "s10.jpg", Price = 1400m },
                        new { Id = 3, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 52, Info = "Huawei P30 pro. Ideal veziyyetdedir...", IsConfirmed = false, IsVip = false, ModelId = 24, Name = "Satilir Huawei P30 Pro", PhotoUrl = "huaweiP30Proo.jpg", Price = 1350m },
                        new { Id = 4, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 1, Info = "Ela veziyyetdir 32gb, Qiymetde Cuzi Endirim Olacaq", IsConfirmed = true, IsVip = false, ModelId = 48, Name = "Satilir Samsung Tab E", PhotoUrl = "samsungTabE.jpg", Price = 450m },
                        new { Id = 5, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 8, Info = "Ipad pro 2018 her bir aksesuari var..", IsConfirmed = false, IsVip = false, ModelId = 44, Name = "Satilir Ipad Pro 2018", PhotoUrl = "ipadPro.jpg", Price = 960m },
                        new { Id = 6, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 52, Info = "Keyfiyyetli plansetdir nomre(4g) destekleyir", IsConfirmed = false, IsVip = false, ModelId = 55, Name = "Satilir Lenovo Tab 4", PhotoUrl = "lenovoTab.jpg", Price = 1350m },
                        new { Id = 7, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 1, Info = "Acer swift 3 14 ekran ram 8 videokarti intel uhd620 1.8Ghz up to 4.0 Ghz", IsConfirmed = true, IsVip = false, ModelId = 78, Name = "Satilir Acer Swift 3", PhotoUrl = "swift3.jpg", Price = 2100m },
                        new { Id = 8, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 8, Info = "Ram 16gb videocarti geforce gtx 1050ti 4gb", IsConfirmed = false, IsVip = false, ModelId = 98, Name = "Satilir Hp Omen", PhotoUrl = "hpOmen.jpg", Price = 2300m },
                        new { Id = 9, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 52, Info = "G3 ram 16gb ssd 256 videocarti 6gb geforce gtx 1060", IsConfirmed = false, IsVip = false, ModelId = 94, Name = "Satilir Dell G3", PhotoUrl = "dellG3.jpg", Price = 1750m },
                        new { Id = 10, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 1, Info = "104 ekran, Uhd,yeni kimidir", IsConfirmed = true, IsVip = false, ModelId = 127, Name = "Satilir Panasonic 4k", PhotoUrl = "sonyTv.jpg", Price = 2100m },
                        new { Id = 11, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 8, Info = "120 ekran,Uhd, qiymetde razilawmaq olar", IsConfirmed = false, IsVip = false, ModelId = 114, Name = "Satilir Sony QHD", PhotoUrl = "panasonicTv.jpg", Price = 2300m },
                        new { Id = 12, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 52, Info = "Lg 104 ekran, Qhd, yeni nesil televizor, Yenidir! qiymet sondur", IsConfirmed = false, IsVip = false, ModelId = 112, Name = "Satilir Lg UHD ", PhotoUrl = "lgTv.jpg", Price = 1750m },
                        new { Id = 13, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 1, Info = "", IsConfirmed = false, IsVip = false, ModelId = 128, Name = "Satilir Apple Watch 4", PhotoUrl = "appleWatch.jpg", Price = 2100m },
                        new { Id = 14, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 8, Info = "", IsConfirmed = false, IsVip = false, ModelId = 135, Name = "Satilir Samsung Watch Active", PhotoUrl = "samsungWatch.jpg", Price = 2300m },
                        new { Id = 15, AddDate = new DateTime(2019, 10, 4, 19, 50, 5, 963, DateTimeKind.Local), AnnouncementCount = 0, CityId = 52, Info = "", IsConfirmed = false, IsVip = false, ModelId = 139, Name = "Satilir Xiaomi Mi Band 4 ", PhotoUrl = "XiaomiWatch.jpg", Price = 1750m }
                    );
                });
            ...
            modelBuilder.Entity("FinalProject.Models.News", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Info = "Sürətli enerji yığma illərdir Android istifadəçiləri üçün daha əlçatan olsa da, artıq iphone 11 Pro və Pro Max istifadəçiləri", PhotoUrl = "iphone11pro.jpg", Title = "Iphone 11PRO MAX" },
                        new { Id = 2, Info = "Galaxy Note 10 modelləri böyük həcmli batareyalara sahib olacaqlar. ", PhotoUrl = "samsungNote10.jpg", Title = "Samsung Galaxy Note10" },
                        new { Id = 3, Info = "Beləliklə hər iki smartfon modeli (P30 və P30 Pro) ön kamera üçün nəzərdə tutulmuş damcı formalı çıxıntı hissə ilə təchiz olunacaq.", PhotoUrl = "huaweiP30pro.jpg", Title = "Huawei P30 Pro" }
                    );
                });
